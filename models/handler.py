...
def test(test_data, args, result_train_file, result_test_file):
    ...
    mae, mape, rmse, mape_node = performance_metrics['mae'], performance_metrics['mape'], performance_metrics['rmse'], performance_metrics['mape_node']
    print('\nPerformance on test set: MAPE: {:5.2f} | MAE: {:5.2f} | RMSE: {:5.4f}|'.format(mape, mae, rmse))
    print('MAPE of potato : {:5.4f} , lettuce : {:5.4f} , onion : {:5.4f} , cucumber : {:5.4f}'.format(mape_node[0],mape_node[1],mape_node[2],mape_node[3]))